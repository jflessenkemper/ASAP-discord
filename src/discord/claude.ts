...
const CORTANA_AUTO_APPROVE_BUDGET_INCREMENT = parseFloat(process.env.CORTANA_AUTO_APPROVE_BUDGET_INCREMENT_USD || process.env.RILEY_AUTO_APPROVE_BUDGET_INCREMENT_USD || '5');
const CORTANA_AUTO_APPROVE_BUDGET_MAX_PASSES = parseInt(process.env.CORTANA_AUTO_APPROVE_BUDGET_MAX_PASSES || process.env.RILEY_AUTO_APPROVE_BUDGET_MAX_PASSES || '4', 10);
const CORTANA_TOKEN_OVERRUN_ALLOWANCE = parseInt(process.env.CORTANA_TOKEN_OVERRUN_ALLOWANCE || process.env.RILEY_TOKEN_OVERRUN_ALLOWANCE || '2000000', 10);
