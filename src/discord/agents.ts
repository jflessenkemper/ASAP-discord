...
const AGENT_REGISTRY = [
  ...
  { id: 'operations-manager',  name: 'Riley (Operations Manager)', handle: 'riley-ops', roleName: 'Riley Ops', aliases: ['operations-manager', 'ops-manager', 'riley-ops', 'self-improvement-manager', 'ops-steward'], emoji: '🛰️', color: 0x2F7A49, voice: 'RileyEL', channelName: '🛰️-operations-manager' },
