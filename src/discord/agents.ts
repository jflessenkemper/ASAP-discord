 ...
 */
// Display fields (name, handle, roleName, aliases, channelName) are rebranded
// to Cortana + Greek pantheon. Agent `id` values are kept stable because they
// are the primary keys for agent_memory, agent_activity_log, agent_learnings,
// and self_improvement_jobs — changing them would orphan historical rows.
const AGENT_REGISTRY = [
  { id: 'qa',                  name: 'Argus (QA)',                 handle: 'argus',      roleName: 'Argus',      aliases: ['qa', 'max', 'argus'],                                                                                          emoji: '🧪',  color: 0x50C878, voice: 'Kore',      channelName: '🧪-qa' },
  { id: 'ux-reviewer',         name: 'Aphrodite (UX Reviewer)',    handle: 'aphrodite',  roleName: 'Aphrodite',  aliases: ['ux-reviewer', 'ux', 'sophie', 'aphrodite'],                                                                    emoji: '🎨',  color: 0x303F9F, voice: 'Puck',      channelName: '🎨-ux-reviewer' },
  { id: 'security-auditor',    name: 'Athena (Security Auditor)',  handle: 'athena',     roleName: 'Athena',     aliases: ['security-auditor', 'security', 'kane', 'athena'],                                                              emoji: '🔒',  color: 0x1F2937, voice: 'Charon',    channelName: '🔒-security-auditor' },
  { id: 'api-reviewer',        name: 'Iris (API Reviewer)',        handle: 'iris',       roleName: 'Iris',       aliases: ['api-reviewer', 'api', 'raj', 'iris'],                                                                          emoji: '📡',  color: 0x708090, voice: 'Fenrir',    channelName: '📡-api-reviewer' },
  { id: 'dba',                 name: 'Mnemosyne (DBA)',            handle: 'mnemosyne',  roleName: 'Mnemosyne',  aliases: ['dba', 'database', 'elena', 'mnemosyne'],                                                                       emoji: '🗄️', color: 0x7C3AED, voice: 'Leda',      channelName: '🗄️-dba' },
  { id: 'performance',         name: 'Hermes (Performance)',       handle: 'hermes',     roleName: 'Hermes',     aliases: ['performance', 'perf', 'kai', 'hermes'],                                                                        emoji: '⚡',  color: 0x0EA5E9, voice: 'Orus',      channelName: '⚡-performance' },
