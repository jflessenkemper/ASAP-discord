...
async function ensureEnvFromSecret(envVar: 'ELEVENLABS_API_KEY' | 'DISCORD_TEST_BOT_TOKEN' | 'ANTHROPIC_API_KEY' | 'GITHUB_TOKEN' | 'ADZUNA_APP_ID' | 'ADZUNA_APP_KEY'): Promise<void> {
